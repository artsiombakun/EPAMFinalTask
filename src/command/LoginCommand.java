...
public class LoginCommand implements Command{
	...
	public void executePage(HttpServletRequest request,	HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(auth==null){
					request.setAttribute(Config.ERROR_ATTR, "Incorrect login or password! Please, try again.");
	...
	private void reloadClientList(HttpServletRequest request, HttpServletResponse response)
